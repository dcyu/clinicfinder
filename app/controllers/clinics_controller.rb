class ClinicsController < ApplicationController
  ...
  private
    ...
    def clinic_params
      params.require(:clinic).permit(:name, :organization, :lat, :lng, :address, :operating_hours, :phone, :cost, :scheduling, :eligibility, :country, shifts_attributes: [:id, :day, :opening_time, :closing_time, :clinic_id, :open, :opening_time2, :closing_time2], capabilities_attributes: [:id, :clinic_id, :topic_id, :available])
    end
end
